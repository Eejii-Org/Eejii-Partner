    ...
    <>
      <div className="flex flex-col gap-4 md:gap-8 items-center justify-center w-full">
        {userTypes.map((ut, index) => (
          <div
            key={index}
            className="relative flex flex-col gap-1.5 bg-white drop-shadow-card py-4 md:py-14 flex-1 items-center justify-center rounded-2xl border hover:bg-black/5 transition-all cursor-pointer w-full"
