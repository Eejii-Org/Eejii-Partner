export const UsersIcon = ({ width = 24, height = 24, color = "black" }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      />
      <path
        d="M8.79999 27C9.45852 25.6513 10.4826 24.5148 11.7555 23.7197C13.0285 22.9247 14.4992 22.5032 16 22.5032C17.5008 22.5032 18.9715 22.9247 20.2444 23.7197C21.5174 24.5148 22.5415 25.6513 23.2 27"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M7.49997 14.5C6.74077 14.5008 5.99703 14.2855 5.35566 13.8792C4.71428 13.473 4.20175 12.8927 3.87795 12.206C3.55416 11.5193 3.43247 10.7546 3.52711 10.0014C3.62176 9.24809 3.92881 8.5373 4.41241 7.95206C4.89601 7.36681 5.53618 6.93127 6.25811 6.69634C6.98004 6.4614 7.75393 6.43677 8.48934 6.62532C9.22475 6.81388 9.89131 7.20782 10.4111 7.76113C10.931 8.31444 11.2826 9.00427 11.425 9.75"
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
